var addGalleryContent = function() {
	$(".options__link").click(function() {
		$.ajax({
			method: "POST",
			url: "../gallery.php",
			data: { name: $(this).text() },
		...
		$(".options__link").removeClass("options__link--active");
		$(this).addClass("options__link--active");
	});
};
...
var initPhotoSwipeFromDOM = function(e) {
	for (
		var t = function(e) {
			...
			n = function(e, t, n, o) {
				...
				if (
					((r = (function(e) {
						for (
							var t, n, o, i, r = e.childNodes, a = r.length, l = [], s = 0;
							s < a;
							s++
						)
							1 === (t = r[s]).nodeType &&
								((o = (n = t.children[0]).getAttribute("data-size").split("x")),
								(i = {
				...
				isNaN(i.index) ||
					(n && (i.showAnimationDuration = 0),
					new PhotoSwipe(a, PhotoSwipeUI_Default, r, i).init());
			},
		...
		o[i].setAttribute("data-pswp-uid", i + 1), (o[i].onclick = t);
	var a = (function() {
